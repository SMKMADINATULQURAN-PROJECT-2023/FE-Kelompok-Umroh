...
import { FaRegPenToSquare, FaRotateLeft, FaTrash } from "react-icons/fa6";
                  ...
                  <div className="flex h-full w-full flex-col space-y-5">
                    ...
                    {values.file_create ? (
                      <div className="overflow-hidden rounded-[10px] border border-primary">
                        <Avatar
                          src={typeof values.file_create === 'string' ? values.file_create : URL.createObjectURL(values.file_create)}
                          // src={values.file_create || URL.createObjectURL(values.file_create)}
                      ...
                      <div className="flex flex-col items-start">
                        ...
                        {values.file_create && (
                          <span className="text-white">
                            {(values.file_create.size / (1024 * 1024)).toFixed(
                              2,
                            )}{" "}
                            MB
                          </span>
                    ...
                    <div className="grid w-full grid-cols-2 gap-x-5 gap-y-3 rounded-[10px] bg-primary p-5">
                      <CustomInput
                        id="username"
                        title="Username"
                        type="text"
                    ...
                    <div className="w-full items-end self-end justify-self-end">
                      <p className="text-[12px]">ⓒ AL - HILAL 2023</p>
                    </div>
                  </div>
                </Form>
              </FormikProvider>
